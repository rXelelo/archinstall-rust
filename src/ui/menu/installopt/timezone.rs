...
pub fn timezone(lang: &str) -> String {
  ...
  let menu_items = vec!["Europe/London".to_string(), "Europe/Kyiv".to_string()];
  ...
  match choice {
    1 => {
      let timezone = String::from("Europe/London");
      return timezone;
    }
    2 => {
      let timezone = String::from("Europe/Kyiv");
      return timezone;
    }
    _ => {
      let timezone = String::from("Nothing");
      return timezone;
    }
  }
}
